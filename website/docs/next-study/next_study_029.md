...
flowchart TD
  ...
  B --> C[app/(site)/layout.tsx<br/>サイト用の外枠]
  C --> D[app/(site)/about/page.tsx<br/>ページ本体]
```
...
flowchart TD
  ...
  B --> C[app/(dashboard)/layout.tsx<br/>管理画面の外枠]
  C --> D[app/(dashboard)/dashboard/page.tsx<br/>ページ本体]
```
