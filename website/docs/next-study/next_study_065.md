...
```mermaid
flowchart TB
  L[app/dashboard/layout.tsx\n(受け取る：children + team + analytics)] --> C[children\napp/dashboard/page.tsx]
  L --> T[team slot\napp/dashboard/@team/page.tsx]
  L --> A[analytics slot\napp/dashboard/@analytics/page.tsx]

  C --> S[app/dashboard/settings/page.tsx\n(メインだけ差し替え)]
  T --> TD[app/dashboard/@team/default.tsx\n(合わない時の保険)]
  A --> AD[app/dashboard/@analytics/default.tsx\n(合わない時の保険)]
```
